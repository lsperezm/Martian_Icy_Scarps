...
if z_ei <= 0
    ...
    if z_pf <= 0
        ...
        % Use skin depth of pore filling ice to calculate dz
        firstLayerThickness = diurnalSkinDepths(2) / ((1-layerGrowth^dailyLayers)/(1-layerGrowth)); % Thickness of first layer based on diurnal skin depth of surface [porous regolith] material
